 ...
 int main()
{
	...
	sf::Text tex;
	sf::Font font;
	font.loadFromFile("C:\\Users\\MMVlasenko\\Desktop\\Lab_1_s_2\\font\\impact.ttf");
	tex.setFont(font);
...
int main()
{
	...
	ClassAnimatedText::AnimatedText texty("Hello, world!", 6);
	texty.SetFonty("C:\\Users\\MMVlasenko\\Desktop\\Lab_1_s_2\\font\\impact.ttf", sf::Color::Cyan, 'u', 24);
